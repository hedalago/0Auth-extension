                    ...
                    memberships.map((membership, index) => {
                        ...
                        return (
                            <span key={membership.title}>
                                <ListItem className={classes.listItem} button divider onClick={() => handleClickOpen(id)}>
                                ...
                                >
                                    <DialogTitle id={`${membership.title}-dialog-title`}>{membership.title}</DialogTitle>
                                    <DialogContent>
                                        {
